...
const pics = [
  require("../../../assets/images/album2/1.jpg"),
  require("../../../assets/images/album2/3.jpg"),
  require("../../../assets/images/album2/4.jpg"),
  require("../../../assets/images/album2/5.jpg"),
  require("../../../assets/images/album2/6.jpg")
];
...
export default function Album2() {
  return (
    <Container>
      ...
      <TextAlbum
        title="Piccolo Festival della Felicità"
        description="Photographs taken in 2016 for the “Little Festival of Happiness” in Monticello d’Alba. The last photo won 
       the competition for the “Moments of Happiness” section."
      />
    </Container>
  );
}
